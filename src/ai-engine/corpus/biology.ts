...
export const BIOLOGY_CORPUS: KnowledgeItem[] = [
  {
    ...
    category: 'Biology',
    keywords: ['cell', 'biology', 'mitochondria', 'nucleus', 'DNA', 'ribosome', 'membrane', 'organelle', 'eukaryote', 'prokaryote', 'powerhouse of the cell', 'powerhouse', 'what makes ATP', 'cell organelles'],
    content: `All living organisms are composed of cells — the fundamental structural and functional unit of life. Prokaryotic cells (bacteria, archaea) lack a membrane-bound nucleus; their DNA floats in the cytoplasm. Eukaryotic cells (plants, animals, fungi) have a nucleus containing chromosomal DNA, and specialised organelles. The cell membrane (phospholipid bilayer) regulates what enters and exits. The nucleus houses DNA and directs cell activity. Mitochondria are the cell's power plants — famously called "the powerhouse of the cell" — and they produce ATP (the cell's energy currency) via cellular respiration (C₆H₁₂O₆ + 6O₂ → 6CO₂ + 6H₂O + energy; a modern estimate is roughly 30–32 ATP per glucose, though older textbooks cite 36–38). The powerhouse of the cell is the mitochondria, NOT the nucleus (the nucleus stores DNA and directs activity, but does not make energy). Ribosomes synthesise proteins by translating mRNA. The endoplasmic reticulum (ER) processes proteins and lipids; the Golgi apparatus packages and ships them. Lysosomes digest waste. Chloroplasts in plant cells conduct photosynthesis. The cytoskeleton — microtubules, actin filaments — gives cells shape and enables movement. Cell division occurs via mitosis (producing two identical daughter cells for growth/repair) or meiosis (producing four genetically unique gametes for sexual reproduction). Understanding cells is fundamental to medicine, genetics, and biotechnology.`,
    createdAt: Date.now(),
  },
  {
