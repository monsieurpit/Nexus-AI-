...
3. **The Richter Scale**: Developed by Charles Richter in 1935, it measures earthquake magnitude on a **logarithmic** scale — each whole-number increase represents a tenfold increase in measured shaking amplitude and roughly 31.6 times more released energy. A magnitude 7 earthquake isn't twice as strong as a magnitude 3.5 — the ground shakes about 3,000 times harder (10^3.5), and it releases on the order of 180,000 times more energy. Modern seismologists more often use the related **Moment Magnitude Scale (Mw)**, which better captures the energy of very large earthquakes, but the public still commonly calls both "the Richter scale."
