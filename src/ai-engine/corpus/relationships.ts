...
export const RELATIONSHIPS_CORPUS: KnowledgeItem[] = [
  {
    ...
    keywords: [
      ...
      'dating basics', 'texting etiquette dating', 'left on read', 'ghosting', 'why do people ghost',
  ...
  },
  {
    ...
    keywords: [
      ...
      'love languages', '5 love languages', 'relationship conflict', 'toxic relationship signs', 'relationship basics',
    ],
  ...
  {
    id: 'kb-relationships-gaslighting',
    title: 'What Gaslighting Actually Is (and How to Tell If It\'s Happening to You)',
    category: 'Relationships',
    keywords: [
      'what is gaslighting', 'how do i know if i am being gaslit', 'gaslighting signs', 'gaslighting examples',
      'am i being gaslit', 'gaslighting in relationships',
    ],
    content: `Gaslighting is a pattern of manipulation where someone repeatedly makes another person doubt their own memory, perception, or judgment of reality — the term comes from the 1944 film "Gaslight," where a husband secretly dims the gas-powered lights in his house and then insists his wife is imagining it when she notices, to make her doubt her own sanity. It's distinct from ordinary disagreement or misremembering — the defining feature is that it's a repeated PATTERN specifically aimed at undermining someone's trust in their own perception, not a one-off argument about what actually happened. Common gaslighting tactics: flatly denying things that demonstrably happened ("that never happened," "you're imagining it," "you're too sensitive") even when there's clear evidence otherwise; trivializing someone's feelings or reactions as an overreaction to shut down a legitimate concern; countering with contradictory claims stated so confidently that the other person starts doubting their own memory; withholding — pretending not to understand or refusing to listen, so the other person can't even get a real conversation about the issue; and diverting — changing the subject or questioning the other person's credibility ("who told you that, they're not reliable") instead of addressing the actual concern. Real signs you might be experiencing it: you frequently apologize even when you're not sure what you did wrong; you constantly second-guess your own memory of events, especially around one specific person; you feel confused or "crazy" after interactions with them in a way you don't around anyone else; you find yourself making excuses for their behavior to other people; and you've stopped sharing your true feelings/opinions because you expect them to be dismissed or twisted around on you. Gaslighting can happen in romantic relationships, friendships, families, and workplaces — it's fundamentally about a power dynamic, not exclusively a romantic-relationship phenomenon. If this pattern sounds familiar, a genuinely useful step is keeping a private record (writing down what actually happened, when) — having a real, contemporaneous record to check against is one of the most direct ways to counter the self-doubt gaslighting specifically targets — and talking to someone outside the situation (a trusted friend, or a therapist) who can offer an outside perspective not distorted by the same dynamic.`,
    createdAt: Date.now(),
  },
];
