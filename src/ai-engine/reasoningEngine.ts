...
const STANDALONE_SLANG_MEANINGS: Record<string, string> = {
  ...
  'no aura': 'a put-down meaning you have zero coolness or presence — the opposite of having aura',
  'zero aura': 'a put-down meaning you have no coolness or presence at all',
  'got no aura': 'telling someone they have zero coolness or presence',
  '0 aura': 'a put-down meaning no coolness or presence whatsoever',
  '1000 aura': 'jokey aura score — "+1000 aura" for something cool, "-1000 aura" for maximally embarrassing',
  'got aura': 'saying someone has real coolness / presence',
  'has aura': 'saying someone has real coolness / presence',
  'have aura': 'saying someone has real coolness / presence',
  'so much aura': 'saying someone radiates coolness / presence',
  ...
  // ===== Mainstream internet / Gen-Z slang (mostly AAVE-origin, not British) =====
  tea: 'gossip or the inside story — "what\'s the tea" means what\'s the gossip',
  'spill the tea': 'share the gossip, tell me everything',
  spill: 'tell me the whole story / share the gossip',
  shade: 'a subtle, disguised insult — "throwing shade" is criticising someone indirectly',
  'throwing shade': 'subtly insulting or disrespecting someone without saying it outright',
  salty: 'bitter or resentful, usually over something small',
  'big mad': 'very upset, especially while trying to act like you\'re not',
  pressed: 'unreasonably bothered or worked up about something',
  flex: 'to show off',
  'weird flex': 'an odd thing to brag about — "weird flex but ok"',
  flexing: 'showing off, usually money, success, or possessions',
  ghost: 'to cut off all contact with someone with no explanation',
  ghosting: 'disappearing on someone completely, no reply, no reason given',
  'vibe check': 'a quick read of whether a person or situation feels right',
  'failed the vibe check': 'gave off bad or off-putting energy',
  extra: 'over-the-top, dramatic, doing way more than the situation calls for',
  basic: 'boringly mainstream, following trends with no personal taste',
  thirsty: 'desperate for attention, approval, or someone romantically',
  'thirst trap': 'a deliberately provocative photo posted to fish for attention',
  clapback: 'a sharp, witty comeback to an insult or criticism',
  receipts: 'screenshots or proof that back up a claim ("post the receipts")',
  stan: 'an obsessive fan — as a verb, to support someone intensely',
  stanning: 'being an intense, devoted fan of someone',
  boujee: 'fancy, upscale, or acting high-class (from bourgeois)',
  bougie: 'fancy or acting fancy — same as boujee',
  turnt: 'hyped up, wild, partying hard',
  woke: 'alert to social injustice — now often used mockingly by opponents',
  cancelled: 'publicly called out and boycotted over offensive behaviour',
  'cancel culture': 'collectively withdrawing support from a public figure who did something offensive',
  shook: 'shocked, rattled, or badly shaken by something',
  'sending me': 'making me laugh uncontrollably — "this is sending me"',
  'im weak': 'I\'m dying laughing',
  periodt: 'emphatic "period" — end of discussion, that\'s final',
  'and i oop': 'reaction to something shocking, awkward, or startling',
  sksksk: 'keyboard mash expressing laughter or secondhand embarrassment',
  'hits different': 'is noticeably better or more affecting than usual',
  'built different': 'unusually tough, skilled, or resilient — wired differently',
  'different breed': 'operating on a whole other level from everyone else',
  'pop off': 'go all out and do something impressively — also: start ranting',
  'popped off': 'went off impressively, delivered hard',
  'go off': 'encouragement to keep going — or sarcastically, "rant away"',
  drag: 'to criticise someone harshly and publicly',
  dragged: 'got harshly roasted or criticised in public',
  'pull up': 'show up somewhere, often to confront someone',
  'throw hands': 'to fight physically',
  'catch these hands': 'a threat to fight someone',
  'square up': 'get ready to fight',
  'on god': 'I swear, for real, no exaggeration',
  'on jah': 'I swear — a version of "on god"',
  'skill issue': 'dismissive — your failure is your own fault, not the game\'s or tool\'s',
  'get good': 'insult telling someone to stop complaining and improve (also "git gud")',
  ez: 'said to taunt after an easy win — "easy"',
  'gg go next': 'this game is already lost, move on to the next one',
  'hes free': 'that opponent is easy to beat',
  scrub: 'a bad or clueless player',
  noob: 'a beginner, or someone playing badly',
  sweat: 'someone trying way too hard in a casual game',
  tryhard: 'someone putting tournament-level effort into a casual setting',
  smurf: 'a skilled player on a low-rank account stomping beginners',
  throwing: 'losing a game you were winning through bad or careless play',
  inting: 'deliberately dying or sabotaging your own team',
  hardstuck: 'unable to climb out of a rank no matter how much you play',
  boosted: 'only reached a rank with someone else\'s help — not actually that good',
  'down bad': 'desperate or lovesick to an embarrassing degree',
  'down horrendous': 'even more down bad',
  'catch feelings': 'to develop romantic feelings, usually unintentionally',
  'caught feelings': 'developed romantic feelings you weren\'t supposed to',
  cuffed: 'in a committed relationship',
  'talking stage': 'the early phase of getting to know a romantic interest before officially dating',
  gaslight: 'to manipulate someone into doubting their own memory or perception',
  girlboss: 'a woman aggressively pursuing success — now mostly used ironically',
  karen: 'an entitled, demanding person who wants to "speak to the manager"',
  'ok boomer': 'dismissive reply to an out-of-touch older opinion',
  boomer: 'an older person — or anyone acting with outdated views',
  zoomer: 'a member of Gen Z',
  doomer: 'someone convinced everything is hopeless',
  yeet: 'to throw something hard — or an exclamation of excitement',
  yoink: 'said while quickly grabbing or taking something',
  'big oof': 'that\'s a rough, painful situation',
  'press f': 'pay respects, from a video-game button prompt',
  'rip bozo': 'mocking someone\'s misfortune',
  bozo: 'a clown, a fool',
  'cope harder': 'taunt — your rationalising isn\'t convincing anyone',
  'stay mad': 'taunt — I don\'t care that you\'re upset',
  bffr: 'be for real — "be serious"',
  ijbol: 'I just burst out laughing — a newer replacement for lol/lmao',
  'the audacity': 'said in disbelief at someone\'s nerve',
  'here for it': 'fully in favour of this, enjoying it',
  mother: 'a woman being iconic and in command — "she\'s mother"',
  'serving looks': 'looking extremely good',
  yas: 'an enthusiastic yes',
  werk: 'go off, do your thing — ballroom-culture encouragement',
  okurr: 'a sassy affirmation, popularised by Cardi B',
  bet: 'okay / agreed / sounds good — or "watch me"',
  'say less': 'I get it, no need to explain further — I\'m on it',
  word: 'agreement — "true", "for real"',
  'i cant': 'I can\'t handle this, it\'s too funny or absurd',
  'left no crumbs': 'did it flawlessly, nothing left to criticise',
  'ate and left no crumbs': 'did something absolutely perfectly',
  'understood the assignment': 'delivered exactly what was needed, and did it well',
  'that aint it': 'that\'s wrong, a bad take, or not good',
  'it aint it chief': 'that\'s a bad idea or a bad take',
  ratioed: 'got more replies than likes — a public sign a post flopped',
  'l plus ratio': 'pile-on taunt — you lost and your post is unpopular',
  'hop off': 'get off my case, leave this alone',
  pluh: 'a filler exclamation, roughly "anyway" (Playboi Carti)',
  maidenless: 'insult — has no romantic prospects (from Elden Ring)',
  'hes him': 'he\'s the standout, operating above everyone else',
  'shes her': 'she\'s the standout, the one everyone notices',
  'so real': 'extremely relatable, painfully true',
  'no thoughts head empty': 'a state of calm blankness, nothing on your mind',
  goofy: 'silly in a slightly pathetic or embarrassing way',
  'goofy ahh': 'ridiculous, silly-looking (censored "goofy ass")',
  'clown': 'a fool — "put on the clown makeup" = I was wrong to believe it',
  'catch a fade': 'to get into a fight / get beaten up',
  'let them cook': 'leave them alone, they\'re onto something',
  'we up': 'we\'re winning / things are going our way',
  'it\'s over': 'defeatist — there\'s no hope now (often ironic)',
  'we\'re so back': 'things are great again (paired with "it\'s over")',
  glizzy: 'a hot dog',
  gng: 'short for "gang" — a friend, or a filler address like "bro"',
  'my boy': 'a close friend',
  slatt: 'gang-affiliated hype ad-lib, "slime love" — used loosely as agreement/hype now',
  'on bro': 'I swear, on my friend',
  'lil bro': 'condescending address to someone you\'re talking down to',
  'be so fr': 'be serious, "be so for real"',
  'not you': 'teasing call-out — "not you doing X"',
  'the way': 'used to flag something notable — "the way I gasped"',
  'in shambles': 'falling apart, a mess (often about oneself, jokingly)',
  'menace to society': 'someone chaotically, entertainingly out of pocket',
};
...
async function llmGroundedOrFallback(
  ...
  const groundedPrompt = usePolish
    ? confident
      ...
      : `Poniższy kontekst może być tylko powierzchownie podobny do pytania (inny temat, inna dziedzina), a nie faktycznie na nie odpowiadać. Oceń go krytycznie: jeśli naprawdę pomaga, potraktuj go jako punkt wyjścia i odpowiedz najlepiej jak potrafisz, uczciwie zaznaczając, jeśli czegoś nie jesteś pewien. Ale jeśli dotyczy zupełnie innego tematu i wcale nie odpowiada na to konkretne pytanie, ZIGNORUJ GO CAŁKOWICIE i odpowiedz z własnej ogólnej wiedzy, otwarcie mówiąc, że nie opierasz się na konkretnym materiale źródłowym. Nigdy nie wymuszaj odpowiedzi zbudowanej z kontekstu o złym temacie tylko dlatego, że go podano. Jeśli pytanie jest tak niejasne, że musiałbyś zgadywać, o jaki temat w ogóle chodzi (nie tylko niepewny fakt, ale brak pojęcia CZEGO to dotyczy) — zamiast zgadywać temat, zapytaj wprost, o co dokładnie chodzi.\n\nKontekst:\n${groundingContext}\n\nPytanie: ${prompt}`
    : useFrench
    ? confident
      ? `Réponds à la question de l'utilisateur EN UTILISANT SEULEMENT les faits ci-dessous. N'invente rien qui n'y est pas.\n\nFaits :\n${groundingContext}\n\nQuestion : ${prompt}`
      : `Le contexte ci-dessous pourrait juste être superficiellement similaire à la question (un sport différent, un domaine différent) sans vraiment y répondre. Juge-le de façon critique : si ça aide vraiment, utilise-le comme point de départ et réponds du mieux que tu peux, en étant honnête si t'es pas certain de quelque chose. Mais si ça parle en fait d'un tout autre sujet et ne répond pas du tout à cette question précise, IGNORE-LE COMPLÈTEMENT et réponds plutôt avec tes propres connaissances générales, en étant clair que tu ne te bases pas sur du contexte spécifique pour cette réponse-là. Ne force jamais une réponse construite à partir d'un contexte sur le mauvais sujet juste parce qu'on te l'a donné. Si la question est tellement vague que tu devrais deviner c'est quoi le sujet exact (pas juste un fait incertain, mais aucune idée de QUOI ça parle) — au lieu de deviner un sujet au hasard, demande directement c'est quoi exactement.\n\nContexte :\n${groundingContext}\n\nQuestion : ${prompt}`
    : confident
    ? // Condensed for latency (see buildLlmKnowledgeInstruction's comment — prefill scales with
      // token count, and this single instruction used to be the biggest chunk of every confident-
      // grounded prompt). Every rule below is preserved from a much longer version that spelled
      // each one out with a full worked example (Pearl Harbor/WWII dates, kilogram of steel vs
      // feathers, a Japan/South-Korea follow-up) — those examples were what originally caught each
    ...
    : // Condensed for latency, same pass as the confident branch above — every rule preserved
      ...
      `The context below might only be superficially similar to the question (a different sport, a different field, a different era) rather than actually answering it — judge it critically. If it genuinely helps, use it as a starting point and answer as well as you genuinely can, honest about what's uncertain rather than inventing specifics. But if it's really about a different topic and doesn't address this specific question at all, IGNORE IT COMPLETELY and answer from your own general knowledge instead, openly saying you're not drawing on specific background material for this one. Never force an answer built from context about the wrong topic just because it was handed to you. If the topic itself is genuinely unclear (not just an uncertain detail — you'd have to GUESS what they even mean), ask a real direct question back ("better at what, exactly?") instead of guessing a topic and running with it. Style directives still fully apply.\n\nContext:\n${groundingContext}\n\nQuestion: ${prompt}`;
...
export async function generateReasoningPath(
  ...
  if (isCrashout) {
    ...
    // Lowered from 5 to 3 for latency: buildGroundingContext feeds every one of these straight
    // into the grounded LLM prompt, and results are already ranked by relevance — the 4th/5th
    // source is typically the weakest match while still costing real prefill time. Live-measured:
    // this alone cut a ~26s grounded reply to ~13-17s with no observed answer-quality regression
    // on regressionCheck.ts.
  ...
  // Lowered from 5 to 3 for latency — see the identical comment on the other results.slice(0, 5)
  // call site above.
  const top = results.slice(0, 3);
