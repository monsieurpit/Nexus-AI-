// Custom-directive parsing & enforcement — split out of the old monolithic ruleEngine.ts
// (2026-09-20) since it's a conceptually distinct system from RaidShield (see raidshield.ts) that
// happened to live in the same file. No behavior change from the split — every regex, threshold,
// and comment carried over verbatim.
...
import { evaluateRaidShieldRules, analyzeMessageSafety } from './raidshield';
