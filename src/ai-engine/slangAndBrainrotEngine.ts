...
export const SLANG_LEXICON: Record<string, string> = {
  ...
  // ---- British / Commonwealth slang ----
  // Nexus should fully understand British English input (British slang, insults, spellings,
  // regional terms) and be able to answer back in kind when the user speaks that way.
  knobhead: 'British insult: an idiot, a fool, an annoying person (also "knob", "nobhead")',
  wanker: 'British insult: a contemptible or obnoxious person (literally someone who masturbates)',
  bellend: 'British insult: an idiot or contemptible person (literally the end of the penis)',
  plonker: 'mild British insult: a fool or idiot (popularised by "Only Fools and Horses")',
  pillock: 'mild British insult: a fool or silly person',
  numpty: 'mild, affectionate British/Scottish insult: a harmlessly stupid or incompetent person',
  muppet: 'mild British insult: someone acting stupidly or incompetently',
  'miserable git': 'British insult: an unpleasant, contemptible, grumpy person',
  tosser: 'British insult: a contemptible or worthless person, similar to "wanker"',
  minger: 'British slang: an unattractive or unpleasant person ("minging" = disgusting, gross)',
  gobshite: 'British/Irish insult: someone who talks a lot of stupid nonsense',
  'slag off': 'British idiom: to criticise, badmouth, or mock someone',
  chav: 'British slang, often classist/derogatory: a young person stereotyped by tracksuits, brand logos, and antisocial behaviour',
  knackered: 'British slang: extremely tired, exhausted; or broken/worn out ("the car\'s knackered")',
  gutted: 'British slang: bitterly disappointed or devastated ("I was gutted we lost")',
  chuffed: 'British slang: very pleased or proud ("chuffed to bits")',
  buzzing: 'British slang: excited, thrilled, or elated about something',
  gobsmacked: 'British slang: utterly astonished, shocked speechless',
  peng: 'British (esp. London/MLE) slang: very attractive, or excellent ("she\'s peng", "peng food")',
  minted: 'British slang: very rich, loaded with money',
  skint: 'British slang: completely broke, having no money',
  quid: 'British slang: one pound sterling ("twenty quid")',
  dosh: 'British slang: money',
  gaff: 'British/Irish slang: someone\'s house or flat ("round my gaff")',
  manky: 'British slang: dirty, disgusting, or in poor condition',
  dodgy: 'British slang: suspicious, unreliable, of poor quality, or slightly illegal',
  naff: 'British slang: tacky, uncool, lacking taste, or (as "naff off") a mild "go away"',
  chuffing: 'British mild intensifier/euphemism for "fucking" ("the chuffing car won\'t start")',
  minging: 'British slang: disgusting, revolting, or very unattractive',
  lush: 'British/Welsh slang: lovely, gorgeous, delicious',
  reyt: 'Northern British spelling of "right", used as a greeting or filler',
  innit: "British tag question, contraction of \"isn't it\", used to seek agreement about anything",
  'taking the piss': 'British idiom: mocking someone, or being unreasonable / pushing your luck',
  'taking the mick': 'British idiom (politer form of "taking the piss"): mocking someone or being unreasonable',
  'on the piss': 'British idiom: out drinking alcohol heavily',
  cba: "British text slang: \"can't be arsed\" (can't be bothered)",
  arsed: 'British slang: bothered, willing to make the effort ("I can\'t be arsed")',
  'chock-a-block': 'British idiom: completely full or crowded ("the road was chocka")',
  bevvy: 'British slang: an alcoholic drink ("going for a few bevvies")',
  scran: 'British/Northern slang: food',
  nosh: 'British slang: food, or to eat',
  butters: 'British (MLE) slang: ugly',
  'long ting': 'British (MLE) slang: something that is a hassle, tedious, or too much effort',
  wagwan: 'British (MLE) greeting, from Jamaican patois "what\'s going on"',
  roadman: 'British slang: a streetwise young man associated with road/gang culture and MLE slang',
  'do one': 'British idiom: an aggressive "go away" / "get lost"',
  'leave it out': 'British idiom: "stop it" or "stop lying/exaggerating"',
  gobby: 'British slang: loud-mouthed, cheeky, prone to talking back',
  cheeky: 'British slang: playfully rude, impudent, or a small indulgent treat ("a cheeky pint")',
  'bang out of order': 'British idiom: completely unacceptable or unfair behaviour',
  chunder: 'British/Australian slang: to vomit',
  kip: 'British slang: a sleep or nap ("having a kip")',
  porkies: 'British Cockney rhyming slang ("pork pies" = lies): lies, fibs',
};
